...
#                     train_extras = np.c_[train_extras, train['GC_100'], train['GC_400'], train['GC_1000']]
                ...
                for bnum in range(5,38):
                    features_key[bnum] = 'Beta' + str(bnum)
            ...
            # Calculate r2 and RMSE
                ...
                paras += "_oob=%s_r2=%s_RMSE=%s_N=%s" % (oob_str, r2, RMSE, X.shape[0])
                uf.storePreds(path, np.c_[features_key, importants], paras, full_feat_start, strs = True)
